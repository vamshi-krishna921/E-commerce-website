      ...
      <div className="relative z-10 w-full h-full flex justify-start items-center gap-2">
        ...
        <div className="w-full h-full flex flex-col justify-center items-center">
          ...
          <p className="text-lg md:text-xl text-zinc-600 max-w-2xl text-center">
            Shop the latest trends in fashion, accessories, and more. Elevate your
            wardrobe with our exclusive collections.
          </p>
          <button className="mt-6 px-8 py-3 bg-orange-500 text-white text-lg font-semibold rounded-full hover:bg-orange-800 transition-colors duration-300 cursor-pointer" onClick={() => 
            navigate("/products")
          }>
            Shop Now
          </button>
